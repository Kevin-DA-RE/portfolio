      ...
      <div class="text-center space-y-8">
        ...
        <div class="max-w-screen-md mx-auto text-center text-5xl md:text-6xl font-bold">
          ...
          <img src="../assets/portrait.png" alt="Portrait"
            class="object-cover rounded-full inline-block mb-3" />
          <h1>
            Je m'appelle Kevin,<br />
            je suis
            <span class="text-transparent bg-gradient-to-r from-[#D247BF] to-primary bg-clip-text">Développeur Web
              Fullstack
            </span>
          </h1>
        </div>
        ...
        <div class="md:space-y-0 md:space-x-4">
          ...
          <Button as-child variant="secondary" class="w-5/6 md:w-1/4 font-bold">
            <a href="https://github.com/Kevin-DA-RE" target="_blank">Github</a>
          </Button>
        </div>
      </div>
