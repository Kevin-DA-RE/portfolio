    ...
    <div class="flex flex-row content-center justify-around w-full h-full">
      ...
      <div class="w-200 m-2 h-100 content-end">
        <ul class="list bg-base-100 shadow-md">
          ...
          <li class="list-row">
            <div class="flex flex-row items-center justify-between px-4 py-2 w-25"
              v-for="(stack, index) in project.stacks"
              :key="index"
            >
              <div>
                <img class="size-7" :src="project.img_stack[index]" />
        ...
        <ul class="list bg-base-100 shadow-md">
          ...
          <li class="list-col p-4" v-for="(desc, index) in project.descriptif" :key="index">
